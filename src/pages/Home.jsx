    ...
    <span className="text-white">&nbsp;&nbsp;ResumeCraft</span>
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
              ...
              <div>
              <Link to={"/input"} className="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#ff0] font-medium text-sm text-neutral-800 rounded-full focus:outline-none">Create Resume</Link>
              </div>
            </div>
          </div>
          {/* End Collapse */}
